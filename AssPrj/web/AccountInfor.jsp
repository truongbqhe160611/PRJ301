        ...
        <div class="form-box">
            <div class="form-value">
                <form style="margin-left: -130px;">
                    ...
                    <input type="text" id="id" name="id" value="${sessionScope.account.id}"><br><br>

                    <label for="name">Name:</label>
                    <input type="text" id="name" name="name" value="${sessionScope.account.name}"><br><br>

                    <label for="email">Email:</label>
                    <input type="email" id="email" name="email" value="${sessionScope.account.email}"><br><br>
